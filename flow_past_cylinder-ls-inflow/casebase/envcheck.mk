...
TESTPYTHONLOCAL=$(shell PYTHONPATH=${PYTHONPATH}:${PWD}/../../fluidity/python python -m fluidity.state_types 2>&1 2>/dev/null; echo $$?)
...
BINPREFIX=$(shell test -x ../../bin/fluidity >/dev/null && echo ${PWD}/../../fluidity/bin/)
